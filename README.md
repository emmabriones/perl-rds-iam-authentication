...
Note: if you get an errors talking about "can't use DBI" or "can't find the MySQL driver", you may need to install Perl's DataBase Interface. `apt-get install -y libdbd-mysql-perl` will do all the magic for you if you're on Debian/Ubuntu.
